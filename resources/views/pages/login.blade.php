        ...
        <div class="col-md-5 col-sm-12 mx-auto">
            <div class="card pt-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="/simpanLogin">
                        {{ csrf_field() }}
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('nik') is-invalid @enderror"  placeholder="NIK" id="nik" name="nik">
                            @error('nik')
                                <span class="invalid-feedback" role="alert">
                                     <strong>{{ $message }}</strong>
                                </span>
